...
client.once('ready', () => {
    ...
    */
    ...
    if (CONFIG.verbosity >= 3) {
        console.log(`Sending Online Status message to ${client.guilds.cache.get(CONFIG.guild_bot_sandbox_id).channels.cache.get(CONFIG.channel_dev_id).name}(${CONFIG.channel_dev_id}).`)
    }
